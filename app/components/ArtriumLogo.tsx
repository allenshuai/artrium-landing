...
/** New text logo (newLogo.svg) – viewBox 1174×202, colored arches + dynamic text. */
const NEW_LOGO_VIEWBOX = { width: 1174, height: 202 };
const NEW_LOGO_ARCH_PATHS: { d: string; fill: string }[] = [
...
const NEW_LOGO_TEXT_PATHS: string[] = [
  "M371.589 75.6676C371.589 54.7996 364.178 36.7593 349.468 22.1121C334.815 7.46497 316.768 0 295.891 0H221.664V195.051H234.62V151.335H295.891C302.907 151.335 309.583 150.543 315.806 148.903L342.623 195.051H357.898L328.422 144.266C335.947 140.703 343.019 135.614 349.412 129.223C364.065 114.576 371.533 96.5356 371.533 75.6676H371.589ZM358.634 75.6676C358.634 92.8596 352.467 107.79 340.246 120.005C328.026 132.22 313.09 138.385 295.891 138.385H234.62V12.9506H295.891C313.09 12.9506 328.026 19.1148 340.246 31.3302C352.467 43.5456 358.634 58.4756 358.634 75.6676Z",
  "M373.795 12.9506H432.124V195.051H445.024V12.9506H503.353V0H373.795V12.9506Z",
  "M676.757 75.6676C676.757 54.7996 669.346 36.7593 654.636 22.1121C639.983 7.46497 621.936 0 601.059 0H526.832V195.051H539.788V151.335H601.059C608.075 151.335 614.75 150.543 620.974 148.903L647.791 195.051H663.066L633.59 144.266C641.115 140.703 648.187 135.614 654.58 129.223C669.233 114.576 676.701 96.5356 676.701 75.6676H676.757ZM663.802 75.6676C663.802 92.8596 657.635 107.79 645.414 120.005C633.194 132.22 618.258 138.385 601.059 138.385H539.788V12.9506H601.059C618.258 12.9506 633.194 19.1148 645.414 31.3302C657.635 43.5456 663.802 58.4756 663.802 75.6676Z",
  "M736.501 0H723.545V195.051H736.501V0Z",
  "M1160.42 0L1076.46 115.99L992.223 0H978.588V195.051H991.544V21.4335L1070.07 129.789H1082.57L1161.1 21.4335V195.051H1174V0H1160.42Z",
  "M97.2531 17.0789L141.835 112.37L142.174 113.049L162.994 126.791L103.703 0H90.7469L31.9648 126.113L52.6715 112.597L97.2531 17.0789Z",
  "M183.022 168.584L182.173 166.661C177.591 156.142 174.253 148.564 167.633 139.572C167.464 139.346 165.88 137.197 164.239 135.274C148.058 116.159 123.561 105.188 96.9705 105.188C67.8906 105.188 38.5845 120.061 25.5721 141.438C22.2341 146.98 16.1806 159.309 12.8426 166.208C8.82573 174.465 5.03516 182.891 1.58405 191.148L-0.0566406 195.05H14.1438L19.2922 183.966C22.1776 177.689 25.0629 171.468 28.0614 165.247C32.0217 157.047 36.7175 148.451 44.1855 141.212C50.0128 135.557 56.4624 130.863 63.2514 127.3C73.6613 121.815 85.3159 118.874 96.9705 118.817C115.188 118.648 132.896 125.717 147.323 138.384C155.187 145.34 161.071 152.975 164.861 161.175L168.482 169.093C172.216 177.236 175.95 185.38 179.741 193.467L180.476 195.107H194.846L193.036 191.092C188.566 181.308 185.172 173.617 182.965 168.64L183.022 168.584Z",
];
      ...
      >
        ...
        >
          ...
          >
            ...
            {NEW_LOGO_TEXT_PATHS.map((d, i) => (
              <path
                key={`text-${i}`}
                d={d}
                fill={scheme.logoText}
